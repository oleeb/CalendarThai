...
public class BuddhaMoonPhaseProvider extends ContentProvider {
     ...
     * The authority
     */
    public static final String AUTHORITY = "com.oleeb.calendarthai.buddhamoonphase.BuddhaMoonPhaseProvider";

    /**
     * Content Uri
     */
    public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/" + BuddhaMoonPhase.TABLE_BUDDHAMOONPHASE);
    ...
    static{
        ...
        sUriMatcher.addURI(AUTHORITY, BuddhaMoonPhase.TABLE_BUDDHAMOONPHASE, GET_BUDDHAMOONPHASE);
    }
