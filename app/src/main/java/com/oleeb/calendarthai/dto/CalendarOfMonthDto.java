...
public class CalendarOfMonthDto {
    ...
    private WeeksOfMonthDto weeksOfMonthDto;
    ...
    public WeeksOfMonthDto getWeeksOfMonthDto() {
        return weeksOfMonthDto;
    }

    public void setWeeksOfMonthDto(WeeksOfMonthDto weeksOfMonthDto) {
        this.weeksOfMonthDto = weeksOfMonthDto;
    }
}
